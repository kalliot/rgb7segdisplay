...
# rgb7segdisplay_x.x.x.x is copied to servers ota subdirectory.
...
echo $FNAME
message='{"dev":"5bc674","id":"otaupdate","file":'\"${FNAME}\"'}'
echo $message
...
mosquitto_pub -h 192.168.101.231 -t home/kallio/rgb7segdisplay/5bc674/otaupdate -m $message
echo 'DONE'
